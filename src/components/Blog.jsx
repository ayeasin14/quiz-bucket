...
const Blog = () => {
    return (
        <div>
            <h1 className='lg:text-3xl md:text-2xl sm:text-xl text-normal font-bold text-white bg-indigo-500 py-2 px-4 my-12 shadow-lg shadow-slate-500 rounded w-1/2 text-center mx-auto'> Frequently Asked Question </h1>
            <div className='bg-slate-300 rounded-md w-11/12 mx-auto grid lg:grid-cols-1 md:grid-cols-1 grid-cols-1 lg:gap-7 md:gap-4 gap-2 lg:p-10 md:p-6 p-2'>

                <div>
                    <p className='bg-slate-400 text-md py-1 px-3 rounded  font-semibold mb-4'>Q: What is The purpose of React Route?</p>
                    <div className='bg-green-800 text-md  py-3 px-5 rounded bg-opacity-70 text-slate-100'>
                ...
                <div>
                    <p className='bg-slate-400 text-md py-1 px-3 rounded mb-4 font-semibold'>Q: How does Context API work?</p>
                    <div className='bg-green-800 text-md  py-3 px-5 rounded bg-opacity-70 text-slate-100'>
                ...
                <div>
                    <p className='bg-slate-400 text-md py-1 px-3 rounded mb-4 font-semibold'>Q: What is useRef hook?</p>
                    <div className='bg-green-800 text-md  py-3 px-5 rounded bg-opacity-70 text-slate-100'>
